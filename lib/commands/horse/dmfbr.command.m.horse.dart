...
class CommandModuleHorse implements ICommand {
  @override
  ...
  void _executeInternal(
    ...
    code.add('begin');
    code.add('  Result := [{Import global modules here}];');
    code.add('end;');
    code.add('');
    code.add('function $moduleName.RouteHandlers: TRouteHandlers;');
    code.add('begin');
    code.add('  Result := [TPingRouteHandler];');
    code.add('end;');
    code.add('');
    code.add('function $moduleName.Routes: TRoutes;');
    code.add('begin');
    code.add('  Result := [RouteModule(\'/ping\', TPingModule)];');
    code.add('end;');
    if (guard) {
